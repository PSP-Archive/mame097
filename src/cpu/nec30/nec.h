...
#define CLKS(v20,v30,v33) { nec_ICount-=(v30)&0x7f; }
#define CLKW(v20o,v30o,v33o,v20e,v30e,v33e,addr) { nec_ICount-=(addr&1)?((v30o)&0x7f):((v30e)&0x7f); }
#define CLKM(v20,v30,v33,v20m,v30m,v33m) { const UINT32 ccount=(v30), mcount=(v30m); nec_ICount-=( ModRM >=0xc0 )?((ccount)&0x7f):((mcount)&0x7f); }
#define CLKR(v20o,v30o,v33o,v20e,v30e,v33e,vall,addr) { const UINT32 ocount=(v30o), ecount=(v30e); if (ModRM >=0xc0) nec_ICount-=vall; else nec_ICount-=(addr&1)?((ocount)&0x7f):((ecount)&0x7f); }
