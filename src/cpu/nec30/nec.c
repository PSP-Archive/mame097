...
void v30_init(void)
{
	...
	for (i=0; i<8; i++) {
		sprintf(buf,"R%d",i);
		state_save_register_UINT16("V30", cpu, buf, &I.regs.w[i], 1);
	}
	for (i=0; i<4; i++) {
		sprintf(buf,"SR%d",i);
		state_save_register_UINT16("V30", cpu, buf, &I.sregs[i], 1);
	}

	state_save_register_UINT16("V30", cpu, "IP", &I.ip, 1);
	state_save_register_UINT8("V30", cpu, "TF", &I.TF, 1);
	state_save_register_UINT8("V30", cpu, "IF", &I.IF, 1);
	state_save_register_UINT8("V30", cpu, "DF", &I.DF, 1);
	state_save_register_UINT8("V30", cpu, "MF", &I.MF, 1);
	state_save_register_INT32("V30", cpu, "SV", &I.SignVal, 1);
	state_save_register_UINT32("V30", cpu, "IV", &I.int_vector, 1);
	state_save_register_UINT32("V30", cpu, "PI", &I.pending_irq, 1);
	state_save_register_UINT32("V30", cpu, "NS", &I.nmi_state, 1);
	state_save_register_UINT32("V30", cpu, "IS", &I.irq_state, 1);
	state_save_register_UINT32("V30", cpu, "AV", &I.AuxVal, 1);
	state_save_register_UINT32("V30", cpu, "OV", &I.OverVal, 1);
	state_save_register_UINT32("V30", cpu, "ZV", &I.ZeroVal, 1);
	state_save_register_UINT32("V30", cpu, "CV", &I.CarryVal, 1);
	state_save_register_UINT32("V30", cpu, "PV", &I.ParityVal, 1);
}
