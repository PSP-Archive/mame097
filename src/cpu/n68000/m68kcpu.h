...
#define ADDRESS_68K(A) ((A)&0x00ffffff/*CPU_ADDRESS_MASK*/)
...
#define MPU_STOPPED 	 m68ki_cpu.stopped
...
#define MPU_INSTR_MODE	 m68ki_cpu.instr_mode
#define MPU_RUN_MODE	 m68ki_cpu.run_mode
...
#define CYC_EXCEPTION		m68ki_exception_cycle_table000
...
typedef struct
{
//	uint dummy_cpu_type;	 /* CPU Type: 68000, 68008, 68010, 68EC020, or 68020 */
...
//	uint cyc_bcc_notake _b;
//	uint cyc_bcc_notake _w;
//	uint cyc_dbcc_f_noe xp;
//	uint cyc_dbcc_f_exp ;
//	uint cyc_scc_r_true;
//	uint cyc_movem_w;
//	uint cyc_movem_l;
...
//extern// static uint8 	m68ki_shift_8_table[];
//extern// static uint16	m68ki_shift_16_table[];
//extern// static uint		m68ki_shift_32_table[];
/*extern*/ static uint8 	m68ki_exception_cycle_table000[48/*256*/];
...
//	}
	...
	if(vector<48)	CPU_INT_CYCLES += (CYC_EXCEPTION[vector]);
