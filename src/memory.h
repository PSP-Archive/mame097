...
typedef UINT8			(*read8_handler)  (UNUSEDARG offs_t offset);
typedef void			(*write8_handler) (UNUSEDARG offs_t offset, UNUSEDARG UINT8 data);
typedef UINT16			(*read16_handler) (UNUSEDARG offs_t offset, UNUSEDARG UINT16 mem_mask);
typedef void			(*write16_handler)(UNUSEDARG offs_t offset, UNUSEDARG UINT16 data, UNUSEDARG UINT16 mem_mask);
#if (0==PSP_NO_CPU32)
typedef UINT32			(*read32_handler) (UNUSEDARG offs_t offset, UNUSEDARG UINT32 mem_mask);
typedef void			(*write32_handler)(UNUSEDARG offs_t offset, UNUSEDARG UINT32 data, UNUSEDARG UINT32 mem_mask);
...
#define READ8_HANDLER(name) 	UINT8  name(UNUSEDARG offs_t offset)
#define WRITE8_HANDLER(name)	void	 name(UNUSEDARG offs_t offset, UNUSEDARG UINT8 data)
#define READ16_HANDLER(name)	UINT16 name(UNUSEDARG offs_t offset, UNUSEDARG UINT16 mem_mask)
#define WRITE16_HANDLER(name)	void	 name(UNUSEDARG offs_t offset, UNUSEDARG UINT16 data, UNUSEDARG UINT16 mem_mask)
#if (0==PSP_NO_CPU32)
#define READ32_HANDLER(name)	UINT32 name(UNUSEDARG offs_t offset, UNUSEDARG UINT32 mem_mask)
#define WRITE32_HANDLER(name)	void	 name(UNUSEDARG offs_t offset, UNUSEDARG UINT32 data, UNUSEDARG UINT32 mem_mask)
#endif //(0==PSP_NO_CPU32)
...
#if (0==PSP_LIGHT_BANK)
/*bankŠg’£*/
#define MAX_EXPLICIT_BANKS		 20 					   /*32 maximum number of explicitly-defined banks */
#else
/*’Êí*/
#define MAX_EXPLICIT_BANKS		 16 					   /*32 maximum number of explicitly-defined banks */
#endif
...
INLINE UINT8  program_read_byte (offs_t offset) { return (*address_space[ADDRESS_SPACE_PROGRAM].accessors->read_byte)(offset); }
INLINE void program_write_byte (offs_t offset, UINT8  data) { (*address_space[ADDRESS_SPACE_PROGRAM].accessors->write_byte)(offset, data); }
INLINE UINT8  data_read_byte (offs_t offset) { return (*address_space[ADDRESS_SPACE_DATA].accessors->read_byte)(offset); }
INLINE void data_write_byte (offs_t offset, UINT8  data) { (*address_space[ADDRESS_SPACE_DATA].accessors->write_byte)(offset, data); }
INLINE UINT8  io_read_byte (offs_t offset) { return (*address_space[ADDRESS_SPACE_IO].accessors->read_byte)(offset); }
INLINE void io_write_byte (offs_t offset, UINT8  data) { (*address_space[ADDRESS_SPACE_IO].accessors->write_byte)(offset, data); }

INLINE UINT16 program_read_word (offs_t offset) { return (*address_space[ADDRESS_SPACE_PROGRAM].accessors->read_word)(offset); }
INLINE void program_write_word (offs_t offset, UINT16 data) { (*address_space[ADDRESS_SPACE_PROGRAM].accessors->write_word)(offset, data); }
INLINE UINT16 data_read_word (offs_t offset) { return (*address_space[ADDRESS_SPACE_DATA].accessors->read_word)(offset); }
INLINE void data_write_word (offs_t offset, UINT16 data) { (*address_space[ADDRESS_SPACE_DATA].accessors->write_word)(offset, data); }
INLINE UINT16 io_read_word (offs_t offset) { return (*address_space[ADDRESS_SPACE_IO].accessors->read_word)(offset); }
INLINE void io_write_word (offs_t offset, UINT16 data) { (*address_space[ADDRESS_SPACE_IO].accessors->write_word)(offset, data); }

#if (0==PSP_NO_CPU32)
INLINE UINT32 program_read_dword(offs_t offset) { return (*address_space[ADDRESS_SPACE_PROGRAM].accessors->read_dword)(offset); }
INLINE void program_write_dword(offs_t offset, UINT32 data) { (*address_space[ADDRESS_SPACE_PROGRAM].accessors->write_dword)(offset, data); }
INLINE UINT32 data_read_dword(offs_t offset) { return (*address_space[ADDRESS_SPACE_DATA].accessors->read_dword)(offset); }
INLINE void data_write_dword(offs_t offset, UINT32 data) { (*address_space[ADDRESS_SPACE_DATA].accessors->write_dword)(offset, data); }
INLINE UINT32 io_read_dword(offs_t offset) { return (*address_space[ADDRESS_SPACE_IO].accessors->read_dword)(offset); }
INLINE void io_write_dword(offs_t offset, UINT32 data) { (*address_space[ADDRESS_SPACE_IO].accessors->write_dword)(offset, data); }
#endif //(0==PSP_NO_CPU32)
