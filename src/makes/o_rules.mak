...
CPU=$(strip $(findstring NEC30@,$(CPUS)))
ifneq ($(CPU),)
OBJDIRS += $(OBJ)/cpu/nec30
CPUDEFS += -DHAS_NEC30=1
CPUOBJS += $(OBJ)/cpu/nec30/nec.o
$(OBJ)/cpu/nec30/nec.o: nec.c nec.h necintrf.h necea.h nechost.h necinstr.h necmodrm.h
else
