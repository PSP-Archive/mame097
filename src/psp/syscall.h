...
{
	u32 TimeStamp;		//frame;			// マイクロ秒？
	u32 Buttons;		//buttons;			// ボタン情報
	unsigned char Lx;	//u8  analog[2];	// 0:X 1:Y
	unsigned char Ly;
	unsigned char Lz;	//u8  dummy[6];
	unsigned char Lw;
	unsigned long unused;
} SceCtrlData;/*ctrl_data_t;*/
...
void sceCtrlReadBufferPositive(/*ctrl_data_t*/SceCtrlData* paddata, int unknown);
void sceCtrlPeekBufferPositive(/*ctrl_data_t*/SceCtrlData* paddata, int unknown);
